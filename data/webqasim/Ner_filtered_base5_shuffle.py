...
for data_type in ["train", "test"]:
    ...
    for row in testing_df.index:
        ...
        try:
            sql_entity = "select relation from webqa where entity= '" + entity + "' order by length(entity) limit 10"
...
with open("./Ner_filtered_base5_shuffle/train.txt", "w", encoding='utf-8') as f:
    f.write("\n".join(train_lines))
    f.close()
with open("./Ner_filtered_base5_shuffle/dev.txt", "w", encoding='utf-8') as f:
    f.write("\n".join(dev_lines))
    f.close()
with open("./Ner_filtered_base5_shuffle/test.txt", "w", encoding='utf-8') as f:
    f.write("\n".join(test_lines))
    f.close()
