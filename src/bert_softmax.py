...
def convert_single_example(ex_index, example, label_list, max_seq_length, tokenizer, mode):
    ...
    # mode='test'的时候才有效，将测试集的序列解析结果保存到文件中
...
def filed_based_convert_examples_to_features(
    ...
    for (ex_index, example) in enumerate(examples):
        ...
        # tf.train.Example/Feature 将数据处理成二进制
...
def main(_):
    ...
    if FLAGS.do_predict:
        ...
        # predict_examples是原始标签，result是预测结果
        ...
        # 将模型预测的结果和原始标签写入到文件中，以空格分开，使用conlleval.py脚本来计算 entity level 的结果并且输出
...
def load_data():
    ...
    print("train_samples number:", len(train_samples))  # 11597
    print("dev_samples number:", len(dev_samples))  # 10448
    print("test_samples number:", len(test_samples))  # 607
    print('=' * 100)
    # print("train_samples:")
    ...
    print('=' * 100)
    # print("training procedure information:")
    # num_train_steps = int(
    #     len(train_samples) / FLAGS.train_batch_size * FLAGS.num_train_epochs)
    # num_warmup_steps = int(num_train_steps * FLAGS.warmup_proportion)
    # print("num_train_steps:", num_train_steps)  # 181
    # print("num_warmup_steps:", num_warmup_steps)  # 18
    # print("num_train_size:", len(train_samples))  # 11598
    # print("train_batch_size:", FLAGS.train_batch_size)  # 64
    # print("num_train_epochs:", FLAGS.num_train_epochs)  # 1
    # print("warmup_proportion:", FLAGS.warmup_proportion)  # 0.1
