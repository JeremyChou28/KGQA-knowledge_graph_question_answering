...
if __name__ == "__main__":
    ...
    if FLAGS.do_predict_outline:
        ...
        ner_predict_error_file = "../nerpredict/webqanerpredict/bert_bilstm_crf/ner_predict_error.txt"
        ner_predict_true_file = "../nerpredict/webqanerpredict/bert_bilstm_crf/ner_predict_true.txt"
        q_t_a_testing_predict_file = "../nerpredict/webqanerpredict/bert_bilstm_crf/q_t_a_testing_predict.txt"
